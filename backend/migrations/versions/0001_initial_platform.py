...
def upgrade() -> None:
    ...
    if op.get_bind().dialect.name != "sqlite":
        ...
        op.create_foreign_key('fk_dp_latest_release', 'crawler_discovered_project', 'crawler_project_release', ['latest_release_id'], ['release_id'], ondelete='SET NULL')
        ...
        op.create_foreign_key('fk_dps_discovered_project', 'crawler_discovered_project_server', 'crawler_discovered_project', ['discovered_project_id'], ['discovered_project_id'], ondelete='CASCADE')
        op.create_foreign_key('fk_project_discovered_project', 'crawler_project', 'crawler_discovered_project', ['discovered_project_id'], ['discovered_project_id'], ondelete='SET NULL')
        ...
        op.create_foreign_key('fk_project_server_latest_release', 'crawler_project_server', 'crawler_project_release', ['latest_release_id'], ['release_id'], ondelete='SET NULL')
        ...
        op.create_foreign_key('fk_release_discovered_project', 'crawler_project_release', 'crawler_discovered_project', ['discovered_project_id'], ['discovered_project_id'], ondelete='CASCADE')
        ...
        op.create_foreign_key('fk_taskdef_latest_release', 'crawler_project_task_definition', 'crawler_project_release', ['latest_release_id'], ['release_id'], ondelete='SET NULL')
...
def downgrade() -> None:
    if op.get_bind().dialect.name != "sqlite":
        ...
        op.drop_constraint('fk_taskdef_latest_release', 'crawler_project_task_definition', type_='foreignkey')
        ...
        op.drop_constraint('fk_release_discovered_project', 'crawler_project_release', type_='foreignkey')
        ...
        op.drop_constraint('fk_project_server_latest_release', 'crawler_project_server', type_='foreignkey')
        ...
        op.drop_constraint('fk_project_discovered_project', 'crawler_project', type_='foreignkey')
        op.drop_constraint('fk_dps_discovered_project', 'crawler_discovered_project_server', type_='foreignkey')
        ...
        op.drop_constraint('fk_dp_latest_release', 'crawler_discovered_project', type_='foreignkey')
