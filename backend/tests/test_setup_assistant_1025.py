...
os.environ['JWT_SECRET'] = 'pytest-jwt-secret-for-crawler-platform-1-0-25'
os.environ['SECRET_ENCRYPTION_KEY'] = 'pytest-secret-encryption-key-for-crawler-platform-1-0-25'
