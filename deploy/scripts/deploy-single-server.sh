...
APP_VERSION_VALUE="$(cp_env_value .env APP_VERSION)"; APP_VERSION_VALUE="${APP_VERSION_VALUE:-1.0.73}"
AGENT_VERSION_VALUE="$(cp_env_value .env AGENT_AGENT_VERSION)"; AGENT_VERSION_VALUE="${AGENT_VERSION_VALUE:-1.1.1}"
