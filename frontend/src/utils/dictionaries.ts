export const statusText: Record<string, string> = {
  ...
  DEPLOYED: '已部署', DEPLOYING: '部署中', DISPATCHING_AGENT: '下发中', PENDING_AGENT: '等待执行端', DISPATCHED: '已下发', DEPLOY_FAILED: '部署失败', REMOVED: '已移除',
  ...
  CREATED: '已创建', SOURCE_CONFIRMED: '发布源确认', CONTRACT_VALIDATED: '契约校验', SERVER_PRECHECKED: '服务器预检', AGENT_DEPLOY_PREPARE: '执行端部署准备', PARSE_ERROR: '解析异常',
