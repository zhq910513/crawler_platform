export const statusText: Record<string, string> = {
  ...
  FEISHU: '飞书', WEWORK: '企业微信', DINGTALK: '钉钉', EMAIL: '邮箱', SYSTEM: '系统', COMPANY: '公司', PROJECT: '项目', LOW: '低 IO', HIGH: '高 IO', AGENT_CLAIMED: 'Agent 已领取', CONTAINER_STARTING: '容器启动中', SPIDER_STARTED: '爬虫已启动', RUN_SUCCEEDED: '执行成功', RUN_FAILED: '执行失败', RUN_TIMED_OUT: '执行超时', IMAGE_PULLING: '拉取镜像', IMAGE_PULLED: '镜像就绪', CONTAINER_CREATING: '创建容器',
}
