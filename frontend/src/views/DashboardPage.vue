...
const cards = computed(() => [
  { title: '项目数量', value: summary.value.projectCount }, { title: '执行节点', value: summary.value.serverCount }, { title: '任务数量', value: summary.value.taskCount }, { title: '运行中', value: summary.value.runningCount }, { title: '等待资源', value: summary.value.waitingCount },
])
